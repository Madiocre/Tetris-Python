...
class Tetris:
    ...
    def play(self, x, rotation, render=False, render_delay=None):
        ...
        score = (lines_cleared ** 2) * Tetris.BOARD_WIDTH ** 2
        self.score += score
    ...
    def render(self, window_name='Tetris'):
        '''Renders the current board to a specific window'''
        ...
        cv2.imshow(window_name, img)  # Use window_name to specify the window
        cv2.waitKey(1)
